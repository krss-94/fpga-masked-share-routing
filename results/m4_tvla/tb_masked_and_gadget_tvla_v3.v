...
// testbench just reads pre-generated rows sequentially from stimulus.mem.
...
//
// stimulus.mem bit layout (MSB to LSB): [population][a_sh0][a_sh1][b_sh0][b_sh1][r]
// Output: tvla_trace.csv, one row per clock cycle.

module tb_masked_and_gadget_tvla_v3;
