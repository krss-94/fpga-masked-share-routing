# build_milestone_xor.tcl
# Synthesis + implementation flow for the masked XOR gadget (gadget #2).
# Mirrors build_milestone0.tcl's structure/target part so outputs are
# directly comparable to Milestone 0's.
#
# Usage:
#   vivado -mode batch -source build_milestone_xor.tcl
