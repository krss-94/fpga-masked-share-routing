open_checkpoint ./test3_place_route_separated_out/post_route.dcp
set fh [open "./lut_inventory_separated.rpt" w]
...
close $fh
puts "Separated LUT count: [llength [get_cells -hierarchical -filter {REF_NAME =~ LUT*}]]"
